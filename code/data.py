...
def prepare_data(img_rows=32, img_cols=32, color_type=3, data_augmentation=True, print_step=True):    
    print('-- prepare_data: Version: 09.11.16.') 
    
    #train=['alley_1', 'bamboo_1', 'bandage_1', 'cave_2', 'market_2', 'market_6', 'shaman_2', 'sleeping_1', 'temple_2']   
    #val=['alley_2', 'bamboo_2', 'bandage_2', 'cave_4', 'market_5', 'mountain_1', 'shaman_3', 'sleeping_2', 'temple_3']
...
if __name__ == '__main__':
    ...
    X, y, X_val, y_val, Xa, ya, Xa_val, ya_val = prepare_data(img_rows, img_cols, color_type, True, True)
